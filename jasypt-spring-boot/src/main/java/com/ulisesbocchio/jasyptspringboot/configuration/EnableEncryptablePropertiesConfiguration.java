 ...
 * <p>The {@link com.ulisesbocchio.jasyptspringboot.encryptor.StringEncryptor} bean is only defined when no other
 * bean of type {@link com.ulisesbocchio.jasyptspringboot.encryptor.StringEncryptor} is present in the Application Context, thus allowing for custom definition if required.</p>
 * <p>The default {@link com.ulisesbocchio.jasyptspringboot.encryptor.StringEncryptor} can be configured through the following properties: </p>
 * <table border="1">
 *     <tr>
